...
export const ListaMensajes = ({lista}) => { /* Define un componente de React llamado ListaMensajes y lo exporta para que pueda ser utilizado en otros archivos, define la prop LISTA */
    return (
        <>
